...
function startWrites(){
    ...
    NAME_LIST.map(function(obj, i){
        var mined_callback = function() {console.log("Inserted ("+String(i+1)+" of "+ String(NAME_LIST.length) +") : " + JSON.stringify(obj));};
        registerName(obj['addr'], obj['name'], obj['owner'],  mined_callback);        
    })
}
